...
PGPASSWORD=pgPassword_placeholder pg_dump --file "/dbbackup/metis-public.workerGroup-table.sql" --host "ip_placeholder" --port "port_placeholder" --username "postgres" --verbose --format=p --table "public.\"workerGroup\"" "metis"
